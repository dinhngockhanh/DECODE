...
#     folder_workplace_sub <- paste0(folder_workplace, "_", n_simulation, "/")
#     load(paste0(folder_workplace_sub, "simulation_1.rda"))
#     A_total <- sum(unlist(simulation$sample_mutational_table_truth_node_mutation_counts[which(grepl("Foreground_", simulation$sample_mutational_table_truth_node_markers))]))
