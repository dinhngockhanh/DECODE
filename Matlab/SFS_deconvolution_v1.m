...
for n_simulation = 1:n_simulations
    ...
    filename        = strcat('/Users/dinhngockhanh/Library/CloudStorage/GoogleDrive-knd2127@columbia.edu/My Drive/RESEARCH AND EVERYTHING/Projects/GITHUB/SFS_CNA_deconvolution/vignettes/TEST_CINner_lite/TEST_CINner_lite_',num2str(n_simulation),'.txt');
    ...
    filename        = strcat('/Users/dinhngockhanh/Library/CloudStorage/GoogleDrive-knd2127@columbia.edu/My Drive/RESEARCH AND EVERYTHING/Projects/GITHUB/SFS_CNA_deconvolution/vignettes/TEST_CINner_lite/TEST_CINner_lite_deconvolution_parameters_',num2str(n_simulation),'.txt');
    ...
    figure(1);clf;
    %   Plot the SFS data
    bar(vec_freq,vec_SFS_real);hold on;
    %   Compute the SFS fit
    ...
    %   Plot the SFS fit
    plot(vec_freq,vec_SFS_model,'r','LineWidth',2);
    filename        = strcat('/Users/dinhngockhanh/Library/CloudStorage/GoogleDrive-knd2127@columbia.edu/My Drive/RESEARCH AND EVERYTHING/Projects/GITHUB/SFS_CNA_deconvolution/vignettes/TEST_CINner_lite/TEST_CINner_lite_deconvolution_',num2str(n_simulation),'.png');
    saveas(gcf,filename)
end
% %-----------Output the parameters of the fitted SFS to a text file
% filename        = '/Users/dinhngockhanh/Library/CloudStorage/GoogleDrive-knd2127@columbia.edu/My Drive/RESEARCH AND EVERYTHING/Projects/MK-Cod.Analysis of the SFS/R/240114 TEST for Koval/TEST_KOVAL_parameters.txt';
% fileID          = fopen(filename,'w');
% fprintf(fileID,'Sample\tA\tp1\tK1\n');
% for i=1:n_simulations
%     fprintf(fileID,'TEST_1_clone_%d\t',i);
%     for j=1:2*max_hump_count+1
%         fprintf(fileID,'%.3f\t',table_parameters(i,j));
%     end
%     fprintf(fileID,'\n');
% end
